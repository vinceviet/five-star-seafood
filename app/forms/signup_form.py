...
class SignUpForm(FlaskForm):
    ...
    lastName = StringField(
        'Last Name', validators=[DataRequired(message='Please provide a last name')])
    ...
    password = StringField('password', validators=[DataRequired(message='Password must be at least 4 characters.')])
