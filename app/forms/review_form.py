...
class ReviewForm(FlaskForm):
    ...
    # stars = SelectField('Rating', choices=[1,2,3,4,5], validators=[DataRequired(message='Please select a rating'), NumberRange(min=1, max=5, message='Rating must be between 1 and 5')])
