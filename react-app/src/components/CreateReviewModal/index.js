...
export default function CreateReviewModal({ productId, user }) {
    ...
    const handleSubmit = async (e) => {
        ...
        await dispatch(createReview(productId, user, newReview)).then(dispatch(getProductDetails(productId)))
            .then(closeModal)
            .catch(async (res) => {
